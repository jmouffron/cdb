...
public class ServiceValidator {
	...
	public static final String NEW_NULL_ENTITY = "Null NewEntity for {}";
	public static final String NULL_NAME_ENTITY = "Null Name on NewEntity for {}";
	...
	public static boolean computerDTOValidator(ComputerDTO newEntity, String entity) throws BadInputException {
		...
		if (newEntity.getIntroduced() != null && newEntity.getDiscontinued() != null
				&& DateUtils.stringToTimestamp(newEntity.getIntroduced())
						.compareTo(DateUtils.stringToTimestamp(newEntity.getIntroduced())) > 0) {
			log.error("Discontinued Date on NewEntity before Introduced Date for {}", entity);
			throw new BadInputException();
		}
