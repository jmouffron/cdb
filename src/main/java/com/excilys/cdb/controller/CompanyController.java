...
public class CompanyController {
  ...
  public String postEditCompany(@RequestParam(required = false) Map<String, String> paths, Model model) {
    String companyName = paths.get("companyName");
...
String companyName = paths.get("companyName");
  ...
  public String postRoot(@RequestParam(required = false) Map<String, String> paths, Model model) {
